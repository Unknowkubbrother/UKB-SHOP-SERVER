...
exports.default = (router) => {
    ...
    router.get('/payment/user', middlewares_1.isAuthenticated, payments_1.getpeymentForUser);
    router.get('/payment', middlewares_1.isAuthenticated, middlewares_1.isStaff, payments_1.getAllpayments);
};
